...
function loading(overlay) {
    ...
    if(overlay) {
        ...
        $('<div id="overlay" class="animated"><div class="row h-100 text-center"><div class="col-sm-12 my-auto"><div class="card card-block" style="background:transparent"><iframe style="zoom: 1.8;border:0;margin: 0 auto;" src="./dist/img/anim_logo.svg" width="140" height="90"></iframe><h3>Loading...</h3></div></div></div></div>').appendTo($('body'));
        $o = $('#overlay h2');
    }
    ...
    loading_interval = setInterval(function() {
        if($m.text() == 'Loading...') $m.text('Loading');
        if($s.text() == '...') $s.text('');
