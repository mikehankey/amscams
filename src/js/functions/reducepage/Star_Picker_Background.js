...
function create_bg_picker(data) {
   ...
   var img_list = '<div class="box" style="overflow-x:auto; position:absolute; width: 400px; top:0; height:'+max_height+'px; z-index:99999"> <h2 class="mb-0"><a data-toggle="collapse" href="#bg_box" role="button" class="d-block dropdown-toggle dt-title" aria-expanded="true">Background</a></h2><div id="bg_box" class="pt-2 collapse show"><div class="gallery gal-resize row text-center text-lg-left ">';
