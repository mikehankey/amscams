...
function create_bg_picker(data) {
   ...
   img_list += '<div class="preview col-md-6 select-to mb-3"><a class="mtt has_soh select_bg select_stack"  title="HD Stack"><img alt="HD Stack" src="'+my_image+'"></a></div>';

   
   // Create list of image picker
   $.each(data,function(i,v) {
      img_list += '<div class="preview col-md-6 select-to mb-3"><a class="mtt has_soh select_bg"  title="Select Background"><img alt="" src="'+v+'"></a></div>';
   });
