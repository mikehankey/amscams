...
function add_radec_info(info) {
   ...
   $('#radec_info').val($('#radec_info').val()+ step + "x:"+parseFloat(info['x_org'])*2+", y:"+parseFloat(info['y_org'])*2+" - HD x:"+ info['x_HD'] + ", y:" + info['y_HD']);
}
...
function add_radec_resolved_info(info) {
   ...
   $('#radec_info').val($('#radec_info').val()+ step + "x:"+parseFloat(info['x_org'])*2+", y:"+parseFloat(info['y_org'])*2+"\n - Az:"+ info['az'].toFixed(4) + ", El:" + info['el'].toFixed(4)+"\n - RA:"+ info['ra'].toFixed(4) + ", Dec:" + info['dec'].toFixed(4));
}
