...
function build_radecpanel() {
   $('#main_container').prepend($('<div id="select_f_tools" class="ui-draggable" style="z-index:999;width: 300px;height: 300px;overflow:auto;color:#fff;background:#000;padding: 0.2rem .3rem;font-family: monospace;">\
