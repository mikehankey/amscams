function update_reduction_on_canvas_and_table(json_resp) {
    ...
    $.each(smf, function(i,v){
        ...
        // If we want to add a colored circle: <div class="st" style="background-color:'+all_colors[i]+'"></div>
        table_tbody_html+= '<tr id="fr_'+frame_id+'" data-org-x="'+v[2]+'" data-org-y="'+v[3]+'"><td></td>'
