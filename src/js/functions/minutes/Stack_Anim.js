...
function addAnimMinuteModalTemplate($allstacks,cam_id) {
   ...
   <div class="modal-content"><div class="modal-body"><div id="anim_header" class="d-flex justify-content-between"><p><b>Stack animation</b> '+d+' Cam#'+cam_id+'</p><p><span id="cur_f"></span></p></div><div id="anim_holder" style="width:688px;">\
