...
function addAnimWeatherModalTemplate($allImagestt,cam_id) {
   ...
   <div class="modal-content" style="width: 590px;"><div class="modal-body"><div id="anim_header" class="d-flex justify-content-between"></div><div id="anim_holder" class="sm" style="height: calc(550px * 9 / 16);width: 550px;">\
