...
# Update / Read / Write default parameters for custom videos
# include fps, dim, extra logo (opt), position of AMS logo, position of camera info, extra info (opt)
# all saved in DEFAULT_VIDEO_PARAM
def update_video_job_parameters(fps,dim,text_pos,wat_pos,extra_text,logo,logo_pos):
    return False
