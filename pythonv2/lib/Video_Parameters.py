...
def create_param_file_if_necessary():
    ...
    if js_file.is_file()== False: 
        ...
        f.write('{"param": {"fps":'+ D_FPS+', "dim":"'+D_DIM+'", "extra_logo": "'+D_EXTRA_LOGO+'", "wat_pos":"'+ D_AMS_LOGO_POS +'", "text_pos":"'+D_CAM_INFO_POS+'", "logo_pos":"'+D_CUS_LOGO_POS+'", "extra_text":"'+  operator_info +  '", "extra_text_pos":"'+  D_EXTRA_INFO_POS + '"}}')
        f.close()
...
def save_video_job_parameters(fps,dim,extra_logo,wat_pos,text_pos,logo_pos,extra_text,extra_text_pos):
    ...
    params['param']['extra_text_pos'] = extra_text_pos 
