...
def browse_day(day,cams_id,json_conf):
   ...
   print("<div><button class='btn btn-primary' id='play_anim_thumb' style='text-transform: initial;'><span class='icon-youtube'></span> All night Animation Preview</button></div></div>") 
