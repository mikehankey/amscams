...
def generate_cropped_frames(video_full_path,analysed_name,meteor_json_file,HD_frames,HD):
   ...
   for frame in meteor_frame_data: 
      ...
      print("frame_index  " + str(frame_index) + "<br>")
      print("ORG HD FRAME " + org_HD_frame + "<br>")
...
def generate_HD_frames(video_full_path, destination):
   ...
   # Get All Frames
   cmd = 'ffmpeg -y -hide_banner -loglevel panic  -i ' + video_full_path + '-vf scale=320:240 -s ' + HD_DIM + ' ' +  destination + EXT_HD_FRAMES + '_%04d' + '.png' 
