...
def crop_video_keep_meteor_centered(json_file,video,w=FRAME_THUMB_W,h=FRAME_THUMB_H):
   ...
   if('frames' in data):
      ...
      for i in range(1,first_index):
         crop = new_crop_thumb(folder_path + os.sep + "frames" + str(i).zfill(5) + ".png",data['frames'][1]['x'],data['frames'][1]['y'],folder_path + os.sep + "frames" + str(i).zfill(5) +"X.png",True,FRAME_THUMB_W,FRAME_THUMB_H)
      ...
      for frame in data['frames']:
         ...
         crop = new_crop_thumb(folder_path + os.sep + "frames" + str(frame_index).zfill(5) + ".png",frame['x'],frame['y'],folder_path + os.sep + "frames" + str(frame_index).zfill(5) +"X.png",True,FRAME_THUMB_W,FRAME_THUMB_H)
         cropped_frames.append(crop.replace('//','/'))
