...
def get_min_details(cam_id,year,month,day,minute_file):
   ...
   return MINUTE_FOLDER +  os.sep + str(year) + os.sep + str((int)month.fill(2))+'_'+str((int)day.fill(2)) + os.sep +str(year)+'_'+str(month)+'_'+str(day)+minute_file.replace(':','_').replace('.','_') + '-' + MINUTE_STACK_EXT + '.png'
