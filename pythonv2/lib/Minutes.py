...
def get_min_details(cam_id,year,month,day,minute_file):
   return MINUTE_FOLDER +  os.sep + str(year) + os.sep + str(month)+'_'+str(day) + os.sep +str(year)+'_'+str(month)+'_'+str(day)+'_'+minute_file.replace(':','_').replace('.','_') + '_' + cam_id + '-' + MINUTE_STACK_EXT + '.png'
