...
MINUTE_HD_VID_FOLDER = '/mnt/ams2/HD'

# Minute stacks regex
MINUTE_TINY_STACK_EXT = "-tn"
MINUTE_NORMAL_STACK_EXT = "-stacked"
MINUTE_STACK_EXT = MINUTE_NORMAL_STACK_EXT + MINUTE_TINY_STACK_EXT
...
def write_day_minute_index(day, month, year):
   ...
   filename = output_dir + os.sep + str(year) + '_' + str(month).zfill(2) + '_' + str(day).zfill(2) + ".json"
