...
def get_text_position_cv(background,text,position,line_number,font,margins=VIDEO_MARGINS):
    ...
    if(position=='br'):
        ...
        if(line_number==1):
            return background_height-abs(text_h)*2-VIDEO_MARGINS-line_number*2-VIDEO_LINE_HEIGHT,background_width-VIDEO_MARGINS-text_w   
        else:
        ...
        if(line_number==1):
            return VIDEO_MARGINS,background_width-VIDEO_MARGINS-text_w
        else:
        ...
        background_width,background_height  = background.shape[1], background.shape[0]
        if(line_number==1):
            return background_height-abs(text_h)*2-VIDEO_MARGINS-line_number*2-VIDEO_LINE_HEIGHT,VIDEO_MARGINS   
        else:
        ...
        if(line_number==1):
            ...
            return VIDEO_LINE_HEIGHT+text_h*line_number,VIDEO_MARGINS    
