...
cmd = 'ffmpeg \
      ...
      -vcodec libx264 -pix_fmt yuv420p -preset '+QUAL+' -r '+FPS+' -g $(('+FPS+' +5)) -b:v '+VBR+' \
      -acodec libmp3lame -ar 44100 -ac 2 -crf:v 3 -b:a 712000 -bufsize 256k -maxrate ' + VBR +' -thread_queue_size 10 \
      -f flv "'+YOUTUBE_URL+'"'
