...
def make_event_station_report(json_file):
   ...
   template = template.replace('{VIDEO}','<video id="main_video_player" controls="" loop="" autoplay="" name="media" src="'+json_file.replace('.json','-HD.mp4')+'"><source type="video/mp4"></video>')
