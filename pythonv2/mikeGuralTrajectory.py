    ...
    if True:
       ...
       for obs_file in obs_info:
          ...
          if obs_file != 'jd_ref' and obs_file != 'event_utc':
             ...
             # Set input points for the first site
             traj_solve.infillTrajectory(thetas, phis, times, lat, lon, alt)
       ...
       plt.scatter(traj_solve.meas_vel[0], all_times[0], marker='+')
       plt.scatter(traj_solve.meas_vel[1], all_times[1], marker='x')
