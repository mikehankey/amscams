      ...
      if day in mid:
         for key in mid[day]:
            ...
            if event_id is None or event_id == "none" or event_id == '':
               ...
               multi_html += "<div class='d-block'><a href='"+video_path+"' class='vid-link btn btn-secondary btn-sm'><span class='icon-youtube'></span></a><span class='multi-b'>Multi</span></div></div></div>"
               ms_count += 1
