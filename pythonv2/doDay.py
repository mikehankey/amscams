...
def make_station_report(day, proc_info = ""):
   ...
   multi_tb += '<div class="lio"><button id="conf_all" class="btn btn-success">Confirm All</button> <button id="del_all" class="btn btn-danger">Delete All</button> <button id="cancel_all" class="btn btn-secondary">Cancel</button></div></div></div>'
