...
add_info_to_frame('/mnt/ams2/CUSTOM_VIDEOS/to_test.png','Mike Hankey Rocks',text_position,extra_text_position,"CAM TEXT",get_watermark_pos('bl'),'/mnt/ams2/CUSTOM_VIDEOS/to_test_res.png','1920:1080','bl','tr',0)