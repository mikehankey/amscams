...
array_of_frames, path  = get_hd_frames_from_HD_repo("10041","2019/19/08","2019/19/08 06:40","2019/19/08 11:40")
print("FRAMES")
print(array_of_frames) 
if(array_of_frames is None):
    print('NO FRAME FOUND') 
else:
    where_path = add_info_to_frames(array_of_frames, path, "2019/19/08", "10041", "This is a test", "/mnt/ams2/CUSTOM_LOGOS/1.png","tl",HD_DIM, "bl","tr")
    t = create_vid_from_frames(array_of_frames, where_path, "2019_19_08",  "10041","30")
    print(t)
