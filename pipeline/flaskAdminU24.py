import sys
sys.path.insert(0, '/home/ams/amscams/pipeline')
import os
os.chdir("/home/ams/amscams/pipeline/")
...
def verify_password(username,password):
   #json_conf = load_json_file("../conf/as6.json")
   logging.debug(f"{username} {password} check")
...
@application.route('/astroAPI/', methods=['POST', 'GET'])
def astAPI():
...
@application.route('/msapi/', methods=['GET', 'POST'])
#auth.login_required
def msapi():
...
@application.route('/obs_review/<day>/', methods=['GET', 'POST'])
#auth.login_required
...
@application.route('/save_points/', methods=['GET', 'POST'])
#auth.login_required
def cntl_save_points():
   ...
   return(resp)
@application.route('/pick_points/<meteor_id>/', methods=['GET', 'POST'])
#auth.login_required
...
@application.route('/point_picker/<date>/', methods=['GET', 'POST'])
#auth.login_required
...
@application.route('/kml_failed/<event_id>/', methods=['GET', 'POST'])
#auth.login_required
...
@application.route('/event_detail/<event_id>/', methods=['GET', 'POST'])
#auth.login_required
...
@application.route('/events/<date>/', methods=['GET', 'POST'])
#auth.login_required
...
@application.route('/api/check_login', methods=['GET', 'POST'])
#auth.login_required
def chk_login():
...
@application.route('/api/add_frame/<meteor_file>/', methods=['GET', 'POST'])
#auth.login_required
...
@application.route('/api/delete_frame/<meteor_file>/', methods=['GET', 'POST'])
#auth.login_required
...
@application.route('/save_man_reduce/', methods=['GET', 'POST'])
#auth.login_required
def save_man_red():
   data = {}
...
@application.route('/meteor_man_reduce/', methods=['GET', 'POST'])
#auth.login_required
def meteor_man_red():
...
@application.route('/save_man_reduce_v2/', methods=['GET', 'POST'])
#auth.login_required
def save_man_redv2():
   data = {}
   data['frame_data'] = request.form.get('frame_data')
...
@application.route('/meteor_man_reduce_v2/', methods=['GET', 'POST'])
#auth.login_required
...
@application.route('/import_meteor/', methods=['GET', 'POST'])
#auth.login_required
...
@application.route('/man_detect/<min_file>/', methods=['GET', 'POST'])
#auth.login_required
...
@application.route('/api/reduce_meteor/<meteor_file>/', methods=['GET', 'POST'])
#auth.login_required
def red_meteor(meteor_file):
   out = reduce_meteor(meteor_file)
   return out

@application.route('/api/delete_meteor/<jsid>/', methods=['GET', 'POST'])
#auth.login_required
def del_meteor(jsid):
   data = {}
...
@application.route('/api/restore_meteor/<jsid>/', methods=['GET', 'POST'])
#auth.login_required
...
@application.route('/api/delete_meteors/', methods=['GET', 'POST'])
#auth.login_required
def del_meteors():
...
@application.route('/cal/lensmodel/<amsid>/', methods=['GET', 'POST'])
#auth.login_required
def lens_mod(amsid):
...
@application.route('/cal/vars/<amsid>/', methods=['GET', 'POST'])
#auth.login_required
def op_vars(amsid):
   if request.method == "POST":
      data = request.form
...
@application.route('/network/setup/<amsid>/', methods=['GET', 'POST'])
#auth.login_required
def net_set(amsid):
...
@application.route('/cal/masks/<amsid>/', methods=['GET', 'POST'])
#auth.login_required
def masks(amsid):
   out = show_masks(amsid)
   return out

@application.route('/edit_mask/<amsid>/<camid>/', methods=['GET', 'POST'])
#auth.login_required
...
@application.route('/calfile/del/<amsid>/<calfile>/', methods=['GET', 'POST'])
#auth.login_required
def del_cfile(amsid, calfile):
   out = del_calfile(amsid, calfile)
   return out

@application.route('/calfile/<amsid>/<calfile>/', methods=['GET', 'POST'])
#auth.login_required
def cfile(amsid, calfile):
   out = cal_file(amsid, calfile)
   return out

@application.route('/calib_new/<amsid>/', methods=['GET', 'POST'])
#auth.login_required
def calib_new(amsid):
   req = {}
...
@application.route('/calib/<amsid>/', methods=['GET', 'POST'])
#auth.login_required
def calib(amsid):
   req = {}
   req['cam_id_filter'] = request.args.get('cam_id_filter')
...
@application.route('/live/<amsid>/', methods=['GET', 'POST'])
#auth.login_required
def live(amsid):
   out = live_view(amsid)
   return out
...
@application.route('/join_min_files/<amsid>/<min_file>/', methods=['GET', 'POST'])
#auth.login_required
...
@application.route('/min_detail/<amsid>/<date>/<min_file>/', methods=['GET', 'POST'])
#auth.login_required
...
@application.route('/stacks_hour/<amsid>/<date>/<hour>/', methods=['GET', 'POST'])
#auth.login_required
...
@application.route('/stacks_day/<amsid>/<date>/', methods=['GET', 'POST'])
#auth.login_required
...
@application.route('/stacks/<amsid>/', methods=['GET', 'POST'])
#auth.login_required
def stacks(amsid):
   req = {}
...
@application.route('/meteors_by_day/<amsid>/', methods=['GET', 'POST'])
#auth.login_required
...
# TRASH PAGE
@application.route('/trash/<amsid>/', methods=['GET', 'POST'])
#auth.login_required
def trash_pg(amsid ):
   req = {}
   start_day = request.args.get('start_day')
...
# REDIS MAIN
@application.route('/rmeteor/<amsid>/', methods=['GET', 'POST'])
#auth.login_required
def rmeteors(amsid ):
   req = {}
   start_day = request.args.get('start_day')
...
@application.route('/confirm_all_trash/<station_id>/<date>/', methods=['GET', 'POST'])
#auth.login_required
...
@application.route('/confirm_non_meteors/', methods=['GET', 'POST'])
#auth.login_required
def cnon_meteors():
   req = {}
...
@application.route('/non_meteors/<amsid>/', methods=['GET', 'POST'])
#auth.login_required
...
# MAIN METEOR PAGE
@application.route('/meteor/<amsid>/<start_day>/', methods=['GET', 'POST'])
#auth.login_required
...
@application.route('/meteor/<amsid>/', methods=['GET', 'POST'])
#auth.login_required
def meteors(amsid ):
   req = {}
   start_day = request.args.get('start_day')
...
@application.route('/goto/meteor/<meteor_file>/', methods=['GET', 'POST'])
#auth.login_required
...
@application.route('/meteor/<amsid>/<date>/<meteor_file>/', methods=['GET', 'POST'])
#auth.login_required
...
@application.route('/TL/<amsid>/<date>/<cam_num>/', methods=['GET', 'POST'])
#auth.login_required
...
@application.route('/DASHBOARD/<amsid>/<subcmd>', methods=['GET', 'POST'])
#auth.login_required
...
@application.route('/DASHBOARD/<amsid>/', methods=['GET', 'POST'])
#auth.login_required
def lrn_dash(amsid):
   from FlaskLib.Dashboard import Dashboard
   from FlaskLib.DashMeteors import MeteorDash
...
@application.route('/NETWORK/EVENTS/<amsid>/<date>/', methods=['GET', 'POST'])
#auth.login_required
...
@application.route('/NETWORK/<amsid>/', methods=['GET', 'POST'])
#auth.login_required
def net_main(amsid):
   out = network_main(amsid, json_conf)
   return(out)

@application.route('/NETWORK/MAP/<amsid>/', methods=['GET', 'POST'])
#auth.login_required
def net_map(amsid):
   out = network_map(amsid, json_conf)
   return(out)

@application.route('/NETWORK/METEORS/<amsid>/', methods=['GET', 'POST'])
#auth.login_required
def net_met(amsid):
...
@application.route('/MOBILE/<amsid>/css/style.css', methods=['GET', 'POST'])
#auth.login_required
def mob_css(amsid):
   options = {}
   if request.method == "POST":
...
@application.route('/MOBILE/<amsid>/serviceWorker.js', methods=['GET', 'POST'])
#auth.login_required
def mob_sw(amsid):
   options = {}
   if request.method == "POST":
...
@application.route('/MOBILE/<amsid>/js/app.js', methods=['GET', 'POST'])
#auth.login_required
def mob_js(amsid):
   options = {}
   if request.method == "POST":
...
@application.route('/MOBILE/<amsid>/manifest.json', methods=['GET', 'POST'])
#auth.login_required
...
@application.route('/MOBILE/<amsid>/', methods=['GET', 'POST'])
#auth.login_required
def mob_main(amsid):
   options = {}
   if request.method == "POST":
...
@application.route('/LEARNING/<amsid>/', methods=['GET', 'POST'])
#auth.login_required
def lrn_main(amsid):
   out = learn_main(amsid)
   return(out)

@application.route('/AIREVIEW/<amsid>/', methods=['GET', 'POST'])
#auth.login_required
def air(amsid):
   options = {}
   for key, value in request.args.items():
...
@application.route('/AI/API/<amsid>/', methods=['GET', 'POST'])
#auth.login_required
def aiapi(amsid):
...
@application.route('/AI/DICT/<amsid>/<date>/', methods=['GET', 'POST'])
#auth.login_required
...
@application.route('/AI/SS/<amsid>/', methods=['GET', 'POST'])
#auth.login_required
def aiss(amsid):
   options = {}
   for key, value in request.args.items():
...
@application.route('/move_ai_sample/', methods=['GET', 'POST'])
#auth.login_required
def mv_sample():
   options = {}
   if request.method == "POST":
...
@application.route('/AI/MAIN/EXPORT/SAMPLES/<amsid>/', methods=['GET', 'POST'])
#auth.login_required
...
@application.route('/AI/MAIN/<amsid>/', methods=['GET', 'POST'])
#auth.login_required
def aimain(amsid):
   out = ai_main(amsid, json_conf)
   return(out)

@application.route('/AIREJECTS/<amsid>/', methods=['GET', 'POST'])
#auth.login_required
def airej(amsid):
   options = {}
   for key, value in request.args.items():
...
@application.route('/AI/NON_METEORS/<amsid>/', methods=['GET', 'POST'])
#auth.login_required
def ainm(amsid):
   options = {}
   for key, value in request.args.items():
...
@application.route('/confirm_meteor/<root_fn>/', methods=['GET'] )
#auth.login_required
def hconfirm(root_fn):
   out = confirm_meteor(json_conf['site']['ams_id'], root_fn )
   return(out)

@application.route('/confirm_non_meteor/<root_fn>/', methods=['GET'] )
#auth.login_required
def confirm_nm(root_fn):
   out = confirm_non_meteor(json_conf['site']['ams_id'], root_fn )
   return(out)

@application.route('/confirm_non_meteor_label/<root_fn>/', methods=['GET'] )
#auth.login_required
def conf_mc(root_fn):
   label = request.args.get('label')
...
@application.route('/LEARNING/<amsid>/BATCH_UPDATE/', methods=['GET', 'POST'])
#auth.login_required
...
@application.route('/LEARNING/<amsid>/RECROP/', methods=['GET', 'POST'])
#auth.login_required
...
@application.route('/LEARNING/<amsid>/RECROP_CONFIRM/', methods=['GET', 'POST'])
#auth.login_required
...
@application.route('/LEARNING/<ams_id>/AI_SCAN/<label>', methods=['GET', 'POST'])
#auth.login_required
...
@application.route('/LEARNING/<amsid>/review/', methods=['GET', 'POST'])
#auth.login_required
...
@application.route('/LEARNING/TAG/<label>', methods=['GET', 'POST'])
#auth.login_required
def lrn_tag(label):
   req = {}
...
@application.route('/LEARNING/<amsid>/WEATHER/<label>', methods=['GET', 'POST'])
#auth.login_required
...
@application.route('/LEARNING/<amsid>/<label>', methods=['GET', 'POST'])
#auth.login_required
...
@application.route('/motion/<date>/', methods=['GET', 'POST'])
#auth.login_required
def cnt_motion(date):
...
@application.route('/API/<cmd>', methods=['GET', 'POST'])
#auth.login_required
def main_api(cmd):
